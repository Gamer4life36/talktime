...
- **Chat rooms** — themed rooms (**Singles, Humor, Gaming, Family Issues,
  Trading Cards, PC Geeks**, and an **18+ NSFW** room), each with its own **post
  feed**, description, and **member count**. Post to a room just like a regular
  post, then like and reply. **Create your own room** too. The NSFW room asks you
